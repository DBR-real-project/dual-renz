...
| 구분 | 내용 |
|---|---|
| **누구를 위한 것인가** | 보이스피싱에 취약한 개인. 특히 **기관 사칭형 전화**를 받는 사람 |
| **지금 해결하는 것** | 통화를 넣으면 **어떤 사기 수법이 쓰였는지 구간별로** 보여준다. 점수만이 아니라 **근거**를 제시한다 |
...
| **범위 밖 (의도적으로 안 함)** | 실시간 가로채기 상용화, 다국어, 영상 딥페이크 단독 판정 |
